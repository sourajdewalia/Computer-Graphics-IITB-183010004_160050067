...
#include "gl_framework.hpp"
	...
	class HNode {
	  ...
	  public:
		...
		void change_init_parameters(GLfloat,GLfloat,GLfloat,GLfloat,GLfloat,GLfloat);
		void change_init_scale(GLfloat,GLfloat,GLfloat);		
		...
		void dec_ry();
		void dec_rz();
		void increment_pos(GLfloat,GLfloat,GLfloat);
		void increment_rot(GLfloat,GLfloat,GLfloat);
	};
